...
namespace BudgetDS.Controllers
{
    ...
    public class InvitesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,HouseholdId,PUser,Code")] Invite invite)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,HouseholdId,PUser,Code")] Invite invite)
        {
            if (ModelState.IsValid)
            {
