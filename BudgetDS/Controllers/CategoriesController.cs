...
namespace BudgetDS.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,HouseholdId,CategoryListId")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,HouseholdId,CategoryListId")] Category category)
        {
            if (ModelState.IsValid)
            {
